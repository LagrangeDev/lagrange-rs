    ...
    UinResolveService {
        ...
        async fn parse(input: Bytes, context: Arc<BotContext>) -> Result<EventMessage> {
            ...
            if let Some(error_data) = tlvs.get(&0x146) {
                ...
                return Ok(EventMessage::new(UinResolveEventResp {
                    state,
                    uin: None,
                    qid: None,
                    tlv_104: None,
            ...
            Ok(EventMessage::new(UinResolveEventResp {
                state,
                uin,
                qid,
                tlv_104,
